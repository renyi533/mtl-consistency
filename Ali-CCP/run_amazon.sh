...
do
  ...
  do
    python ./model/train.py --val_data_dir ./data/video_games/val --train_data_dir ./data/video_games/train --uniq_feature_cnt 24304,10672 --batch_size 512 --embedding_dim 8 --model_dir ./ckpt/video_games/${model}_dml_$i --mode training --early_stop 5 --keep_prob 0.5,0.5,0.5  --model ${model} --global_experience_attn_layer 1 --task_layers 128,80 --co_attention True --global_experience True --epoch 100 > logs/${model}_dml_train_$i.log 2>&1 &
    ...
    python ./model/train.py --test_data_dir ./data/video_games/train  --uniq_feature_cnt 24304,10672 --batch_size 512 --embedding_dim 8 --model_dir ./ckpt/video_games/${model}_dml_$i/best --mode pred --model ${model} --global_experience_attn_layer 1 --task_layers 128,80 --co_attention True --global_experience True --epoch 1 --pred_file logs/${model}_dml_result_train_$i.txt > logs/${model}_dml_test_$i.log 2>&1 &
    ...
    python ./model/train.py --test_data_dir ./data/video_games/val  --uniq_feature_cnt 24304,10672 --batch_size 512 --embedding_dim 8 --model_dir ./ckpt/video_games/${model}_dml_$i/best --mode pred --model ${model} --global_experience_attn_layer 1 --task_layers 128,80 --co_attention True --global_experience True --epoch 1 --pred_file logs/${model}_dml_result_val_$i.txt > logs/${model}_dml_test_$i.log 2>&1 &
    ...
    python ./model/train.py --train_data_dir ./data/video_games/train --uniq_feature_cnt 24304,10672 --batch_size 512 --embedding_dim 8 --model_dir ./ckpt/video_games/aitm_$i --mode training --early_stop 5 --keep_prob 0.5,0.5,0.5  --model aitm --epoch 100 > logs/aitm_train_$i.log 2>&1 &
    wait_function
    python ./model/train.py --test_data_dir ./data/video_games/test --uniq_feature_cnt 24304,10672 --batch_size 512 --embedding_dim 8 --model_dir ./ckpt/video_games/aitm_$i/best --mode pred --model aitm --epoch 1 --pred_file logs/aitm_dml_result_$i.txt > logs/aitm_test_$i.log 2>&1 &
    wait_function
