...
do
  ...
  do
    ...
    python ./model/train.py --model_dir ./ckpt/ali-ccp/${model}_attn_$i --mode training --early_stop 3 --keep_prob 0.9,0.7,0.7  --model ${model} --co_attention True --global_experience False --epoch 50 > logs/${model}_attn_train_$i.log 2>&1 &
    python ./model/train.py --model_dir ./ckpt/ali-ccp/${model}_global_$i --mode training --early_stop 3 --keep_prob 0.9,0.7,0.7  --model ${model} --co_attention False --global_experience True --epoch 50 > logs/${model}_global_train_$i.log 2>&1 &
    wait_function
    
    python ./model/train.py --model_dir ./ckpt/ali-ccp/${model}_dml_$i/best --mode pred --model ${model} --co_attention True --global_experience True --epoch 1 --pred_file logs/${model}_dml_result_$i.txt > logs/${model}_dml_test_$i.log 2>&1 &
    python ./model/train.py --model_dir ./ckpt/ali-ccp/${model}_$i/best --mode pred --model ${model} --co_attention False --global_experience False --epoch 1 --pred_file logs/${model}_result_$i.txt > logs/${model}_test_$i.log 2>&1 &
